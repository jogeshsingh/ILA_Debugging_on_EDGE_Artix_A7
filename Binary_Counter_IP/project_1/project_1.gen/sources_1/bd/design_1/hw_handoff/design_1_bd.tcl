...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set CE_1 [ create_bd_port -dir I -type ce CE_1 ]
  ...
  connect_bd_net -net CE_1_1 [get_bd_ports CE_1] [get_bd_pins c_counter_binary_0/CE] [get_bd_pins ila_0/probe1]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins ila_0/probe0]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ila_0/clk]
